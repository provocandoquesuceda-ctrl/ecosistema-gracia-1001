...
export default function UniversidadPage() {
  return (
    <main className="min-h-screen bg-slate-900 text-white p-6 max-w-5xl mx-auto space-y-8">
      ...
      <section className="bg-gradient-to-r from-emerald-950/40 to-slate-800 p-6 rounded-3xl border border-emerald-800/60 space-y-3">
        <div className="flex justify-between items-center flex-wrap gap-2">
          <div>
            <h2 className="text-base font-bold text-emerald-300">🎉 ¿Eres un nuevo estudiante?</h2>
            <p className="text-xs text-slate-300">Completa tu proceso de bienvenida e inicia tu primer trimestre.</p>
          </div>
          <Link
      ...
      <section className="bg-slate-800/80 p-6 rounded-3xl border border-slate-700 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <Link
            ...
            className="bg-slate-900 hover:bg-slate-750 p-3.5 rounded-2xl border border-slate-700 hover:border-teal-400 text-teal-300 text-xs font-bold transition-all flex items-center gap-2"
          >
          ...
          <Link
            ...
            className="bg-slate-900 hover:bg-slate-750 p-3.5 rounded-2xl border border-slate-700 hover:border-emerald-400 text-emerald-300 text-xs font-bold transition-all flex items-center gap-2"
          >
            <span>✍️</span> Inscripción
          </Link>
        </div>
      </section>
    </main>
